  ...
  >
    Tripathi Legal Services-2021
          ...
          <div className="hidden md:flex items-center gap-3">
            <div className="flex items-center justify-center w-9 h-9 rounded-full border border-stone-400 text-stone-700">
      ...
      {menuOpen && (
        <div className="md:hidden bg-white border-t border-stone-200 px-6 py-4">
          <nav className="flex flex-col gap-4">
            ...
            <a
              href="tel:09266796902"
              className="flex items-center gap-2 text-sm font-medium text-stone-700 hover:text-amber-800 pt-2 border-t border-stone-100"
            >
              <Phone size={14} />
              0-9266796902
            </a>
